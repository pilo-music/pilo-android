        ...
        try {
            ...
            switch (action) {
                ...
                case ACTION_PREVIOUS:
                    if (!Constant.isOnline || Utils.isNetworkAvailable(getApplicationContext())) {
                        previous();
                    } else {
                        Toast.makeText(getApplicationContext(), getResources().getString(R.string.server_connection_error), Toast.LENGTH_SHORT).show();
                    }
                    break;
                case ACTION_NEXT:
                    if (!Constant.isOnline || Utils.isNetworkAvailable(getApplicationContext())) {
