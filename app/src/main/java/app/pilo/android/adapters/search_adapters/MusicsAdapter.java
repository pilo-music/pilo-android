...
public class MusicsAdapter extends RecyclerView.Adapter<MusicsAdapter.MusicAdapterViewHolder> {
    ...
    public MusicAdapterViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        return new MusicsAdapter.MusicAdapterViewHolder(view);
    }
    ...
    public void onBindViewHolder(@NonNull MusicAdapterViewHolder holder, final int position) {
        ...
        holder.ll_music_item.setLayoutParams(params);
